...
export const OFFICIAL_PREVIEW_URL = 'https://chat-preview.ai-dotnet.com/';
...
export const DOCKER_IMAGE = 'https://hub.docker.com/r/ai-dotnet/lobe-chat';
...
export const PLUGINS_INDEX_URL = 'https://chat-plugins.ai-dotnet.com';

export const MORE_MODEL_PROVIDER_REQUEST_URL =
    'https://github.com/ai-dotnet/lobe-chat/discussions/1284';

export const MORE_FILE_PREVIEW_REQUEST_URL =
    'https://github.com/ai-dotnet/lobe-chat/discussions/3684';

export const AGENTS_INDEX_GITHUB = 'https://github.com/ai-dotnet/lobe-chat-agents';
export const AGENTS_INDEX_GITHUB_ISSUE = urlJoin(AGENTS_INDEX_GITHUB, 'issues/new');

export const SESSION_CHAT_URL = (id: number = INBOX_SESSION_ID, mobile?: boolean) =>
    qs.stringifyUrl({
...
export const EMAIL_SUPPORT = 'support@ai-dotnet.com';
export const EMAIL_BUSINESS = 'hello@ai-dotnet.com';

export const MEDIDUM = 'https://medium.com/@ai-dotnet';
export const X = 'https://x.com/ai-dotnet';
export const RELEASES_URL = urlJoin(GITHUB, 'releases');

export const mailTo = (email: string) => `mailto:${email}`;

export const AES_GCM_URL = 'https://datatracker.ietf.org/doc/html/draft-ietf-avt-srtp-aes-gcm-01';
export const BASE_PROVIDER_DOC_URL = 'https://ai-dotnet.com/docs/usage/providers';
export const SITEMAP_BASE_URL = 'sitemap';
